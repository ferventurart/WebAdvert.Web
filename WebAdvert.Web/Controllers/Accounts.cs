...
namespace WebAdvert.Web.Controllers
{
    public class Accounts : Controller
    {
        ...
        {
            var model = new SigunpModel();
            return View(model);
        }

        [HttpPost]
        public async Task<IActionResult> Signup(SigunpModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user.Status != null)
                {
                    ModelState.AddModelError("UserExists", "User with this email alredy exists");
                    return View(model);
                }
